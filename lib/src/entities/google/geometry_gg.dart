...
class GeometryGG {
  ...
  GeometryGG({this.location, this.locationType, this.viewport});
  ...
  Map<String, dynamic> toJson() => {"location": location?.toJson(), "location_type": locationType, "viewport": viewport?.toJson()};
}
